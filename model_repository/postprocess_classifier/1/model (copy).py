...
class TritonPythonModel:
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            # Ensure shape is (3, 640, 640)
            if image_np.ndim == 4:
                image = image_np[0]  # Remove batch dimension
            elif image_np.ndim == 3:
                image = image_np  # Already (3, 640, 640)
            else:
            ...
            image = np.transpose(image, (1, 2, 0))  # Now this should work safely
